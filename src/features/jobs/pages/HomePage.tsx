...
export function HomePage() {
  ...
  const filtered = useMemo(() => {
    return visible.filter((j) => {
      const matchesQ =
        !q || (j.title + " " + j.dept + " " + j.location).toLowerCase().includes(q.toLowerCase());
  ...
  return (
    <>
      ...
      <section className="caa-hero-photo pt-20 pb-36 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          <div className="max-w-2xl">
            ...
            <p className="text-white/85 max-w-xl mt-5 text-base md:text-lg caa-fade-up caa-delay-2">
              Join Uganda's national aviation regulator. We're looking for skilled professionals
              committed to advancing safe, secure and sustainable air transport.
            </p>
            <div className="flex flex-wrap gap-3 mt-8 caa-fade-up caa-delay-3">
              <Link
                to="/vacancies"
                className="px-6 py-3 bg-white text-caa-navy font-semibold rounded-md hover:bg-caa-gold-2 transition-colors"
              >
                Browse Vacancies
              </Link>
              <a
        ...
        <svg
          className="caa-diag-divider absolute bottom-0 left-0 right-0"
          viewBox="0 0 1440 48"
        ...
        <div className="mx-auto max-w-5xl bg-white rounded-xl border border-caa-border shadow-[0_10px_40px_-10px_rgba(11,46,95,0.18)] p-4 md:p-5">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_auto_auto] gap-3">
            ...
            <select
              ...
              className="px-3 py-2.5 text-sm border border-caa-border rounded-md bg-white"
            >
      ...
      <section id="featured" className="px-4 sm:px-6 mt-16">
        <div className="mx-auto max-w-5xl">
          <div className="flex items-end justify-between mb-6">
            ...
            <Link
              to="/vacancies"
              className="text-sm text-caa-navy hover:text-caa-gold inline-flex items-center gap-1"
            >
