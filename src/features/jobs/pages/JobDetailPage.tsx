...
import { useApp, type JobRequirement } from "@/app/providers/AppContext";
import { criteria as criteriaApi } from "@/services/api/client";
import { closingLabel, isClosingSoon } from "@/features/jobs/utils/deadline";
import { JobDocument } from "@/features/jobs/components/JobDocument";
...
export function JobDetailPage() {
  const { jobId } = useSearch({ from: "/job" });
