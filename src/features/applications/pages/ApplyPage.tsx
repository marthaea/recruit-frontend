...
import { useApp, EMPTY_CV, screeningAnswerPasses, type CvProfile, type CvQualification, type QualLevel, type ScreeningQuestion } from "@/app/providers/AppContext";
import { criteria as criteriaApi } from "@/services/api/client";
import { SuccessModal } from "@/features/applications/components/SuccessModal";
import { O_LEVEL_SUBJECTS, A_LEVEL_SUBJECTS, O_LEVEL_GRADES, A_LEVEL_GRADES, QUAL_LEVELS, UGANDAN_UNIVERSITIES, COMMON_COURSES } from "@/constants/uganda-curriculum";
import { extractPdfText } from "@/services/documents/pdf-extract";
import { computeCvCompletion } from "@/features/candidate/utils/cv-completion";
import { isValidEmail, isValidPhone, isFullName } from "@/utils/validators";
