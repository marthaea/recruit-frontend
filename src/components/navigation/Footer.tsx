...
const SOCIAL_FOLLOW = [
  ...
  {
    Icon: SvgLinkedIn,
    href: "https://www.linkedin.com/company/uganda-civil-aviation-authority",
    label: "LinkedIn",
  },
            ...
            <div>
              ...
              <div className="mt-6 pt-5 border-t border-white/10">
                ...
                <div className="flex flex-col gap-2">
                  <Link
                    to="/vacancies"
                    className="text-white/75 text-[13px] hover:text-white transition-colors"
                  >
                    Current Vacancies
                  </Link>
                  <Link
            ...
            <div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                ...
                <p className="text-white/70 text-[12px] leading-relaxed mb-4">
                  Official account of the Uganda Civil Aviation Authority — the national regulator
                  of civil aviation in Uganda.
                </p>
